...
const URL = "https://jsonplaceholder.typicode.com/123456";
...
$("article").append('<button id="btn1">POST</button>');
$("#btn1").click( () =>
        $.post(URL, function (respuesta, estado) {
                ...
                } else if (estado.status === 404){
                       alert("esto es un errror fatal")
                }
        })
)
